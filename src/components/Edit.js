                    ...
                    <div className="panel-body">
                        ...
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                {/* <textarea className="form-control" name="description" onChange={this.onChange} placeholder="Description" cols="80" rows="3" defaultValue={this.state.description}></textarea> */}
                                <input type="text" className="form-control" name="description" value={this.state.description} onChange={this.onChange} placeholder="Title"/>
                            </div>
                            <div className="form-group">
